...
write.csv(Divs_FA,"ODE_Neigh_E8_d1_A.csv",quote=F,row.names=F)
write.csv(Divs_DD,"ODE_Add_v5_d1_A.csv",quote=F,row.names=F)
write.csv(Divs_DD2,"ODE_Add_v5V2_d1_A.csv",quote=F,row.names=F)

write.csv(Divs_FA_SH,"ODE_Neigh_E8_d1_SH_A.csv",quote=F,row.names=F)
write.csv(Divs_DD_SH,"ODE_Add_v5_d1_SH_A.csv",quote=F,row.names=F)
write.csv(Divs_DD2_SH,"ODE_Add_v5_d1_SH_A.csv",quote=F,row.names=F)
