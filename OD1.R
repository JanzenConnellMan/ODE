...
set.seed(150)
Alpha.List<- seq(.1,5,length=100)
SD.FEC <- seq(.1,1,length=100)
...
write.csv(Divs_FA,"Neigh_E8_d1.csv",quote=F,row.names=F)
write.csv(Divs_DD,"Add_v5_d1.csv",quote=F,row.names=F)
