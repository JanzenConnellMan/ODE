...
write.csv(Divs_FA,"ODE_NonFix_Y10_B.csv",quote=F,row.names=F)
write.csv(Divs_FA2,"ODE_AddFix_Y10_B.csv",quote=F,row.names=F)
write.csv(Divs_DD,"ODE_AddExp_Y10_B.csv",quote=F,row.names=F)
write.csv(Divs_DD2,"ODE_NonExp_Y10_B.csv",quote=F,row.names=F)

write.csv(Divs_FA_SH,"ODE_NonFix_Y10_SH_B.csv",quote=F,row.names=F)
write.csv(Divs_FA2_SH,"ODE_AddFix_Y10_SH_B.csv",quote=F,row.names=F)
write.csv(Divs_DD_SH,"ODE_AddExp_Y10_SH_B.csv",quote=F,row.names=F)
write.csv(Divs_DD2_SH,"ODE_NonExp_Y10_SH_B.csv",quote=F,row.names=F)
